...
#import "UIBackyardCallButton.h"
#import "LinphoneManager.h"

#import <CoreTelephony/CTCallCenter.h>

@implementation UIBackyardCallButton

@synthesize addressField;

#pragma mark - Lifecycle Functions

- (void)initUIBackyardCallButton {
...
*/
    ...
    NSString *address = @"sip:Backyard_Gate@192.168.1.237";
    if ([address length] > 0) {
